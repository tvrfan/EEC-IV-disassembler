...
#define SADVERSION "5.0.3 Alpha"
#define SADDATE    "04 Jan 2024"
...
typedef struct inst
{
  ...
  // [0-3] [4-7]           // for printing ??? [4] used already for copy of [1] ....
...
typedef struct            // OPCODE definition structure
 {
  ...
  uchar fend    [3];             // opsizes as 0-x (field end), +0x20 if signed, +0x40 if write, use as true/false extras for jumps

...
{ 3 ,  0, 0,   1, 2,   0x7,   0x1f, 0x15f, shl   ,"shldw" , "\3 <<= \1;" },

{ 4 ,  0, 0,   1, 2,   0x7,   0xf,  0x4f,  shr   ,"shrw"  , "\3 >>= \1;" },                // 4
{ 4 ,  0, 0,   1, 2,   0x7,   0x2f, 0x16f, shr   ,"asrw"  , "\3 >>= \1;" },
{ 4 ,  0, 0,   1, 2,   0x7,   0x1f, 0x15f, shr   ,"shrdw" , "\3 >>= \1;" },               // 6
{ 4 ,  0, 0,   1, 2,   0x7,   0x3f, 0x17f, shr   ,"asrdw" , "\3 >>= \1;" },
{ 4 ,  0, 0,   1, 2,   0x7,   0x7,  0x47,  shr   ,"shrb"  , "\3 >>= \1;" },                // 8
{ 4 ,  0, 0,   1, 2,   0x7,   0x27, 0x167, shr   ,"asrb"  , "\3 >>= \1;" },
...
{ 8 ,  1, 0,   0, 2,   0x7,   0x107, 0x14f, mlx   ,"ml2b"  , "\3 = \2 * \1;" },           // 14
...
{ 11,  1, 0,   1, 2,   0x7,  0x10f, 0x547, dvx   ,"divb"  , "\3 = \2 / \1;\n\3 = \2 % \1;" },           // 36
{ 11,  0, 0,   1, 2,   0x27, 0x12f, 0x567, dvx   ,"sdivb" , "\3 = \2 / \1;\n\3 = \2 % \1;"},            // 37
{ 11,  1, 0,   1, 2,   0xf,  0x11f, 0x54f, dvx   ,"divw"  , "\3 = \2 / \1;\n\3 = \2 % \1;" },           // 38
{ 11,  0, 0,   1, 2,   0x2f, 0x13f, 0x56f, dvx   ,"sdivw" , "\3 = \2 / \1;\n\3 = \2 % \1;"},            // 39

{ 12,  0, 0,   0, 2,   0x7,  0x7,  0x47, ldx   ,"ldb"   , "\4\3 = \1;" },                // 40
{ 12,  0, 0,   0, 2,   0xf,  0xf,  0x4f, ldx   ,"ldw"   , "\4\3 = \1;" },

{ 6 ,  0, 0,   1, 2,   0x807,  0x7,  0x47, add   ,"adcb"  , "\3 += \1;"},      //"\3 = \2 + \1;" },            // 42  x31 ->x30 is skip if zero
{ 6 ,  0, 0,   1, 2,   0x80f,  0xf,  0x4f, add   ,"adcw"  , "\3 += \1;"},      //"\3 = \2 + \1;" },
{ 7 ,  0, 0,   1, 2,   0x807,  0x7,  0x47, sbt   ,"sbbb"  , "\3 -= \1;"},      //"\3 = \2 - \1;" },      // go back to += ??
{ 7 ,  0, 0,   1, 2,   0x80f,  0xf,  0x4f, sbt   ,"sbbw"  , "\3 -= \1;"},      // "\3 = \2 - \1;" },
...
{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jnst"  , "\xbSKY = 0) \x9" },          // 54  to 71 cond jumps
{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jst"   , "\xbSKY = 1) \x9" },          // 55

{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jnc"   , "\10CY = 0) \x9" },            // 56  (\10 = 8)
{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jc"    , "\10CY = 1) \x9" },            // 57

{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jnv"   , "\xbOVF = 0) \x9" },           // 58
{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jv"    , "\xbOVF = 1) \x9" },           // 59

{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jnvt"  , "\xbOVT = 0)" },          // 60
{ 19,  0, 0,   0, 1,   0,    0,    0,    cjm   ,"jvt"   , "\xbOVT = 1)" },          // 61
...
{ 22,  0, 0,   1, 2,   0x107,  0x11f, 0x47, nrm   ,"norm"  ,  "\1 = normalize(\2);\n\2 <<= \1; " },                    //needs more !!!
...
{ 22,  0, 0,   1, 1,   0x107,  0,    0x16f, sex   ,"sexb"  ,  "\3 = \1;" },
{ 22,  0, 0,   1, 1,   0x01f,  0,    0x17f, sex   ,"sexw"  ,  "\3 = \1;" },                // 100
